...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"EmChes/feeds/cambien1", "EmChes/feeds/cambien2", "EmChes/feeds/cambien3", "EmChes/feeds/nutnhan1", "EmChes/feeds/nutnhan2", "EmChes/feeds/ai"};

    final String clientId = "12345678";
    final String username = "EmChes";
    final String password = "aio_hZRZ47DHfsk67ZGpT99gIkWoHyPA";
